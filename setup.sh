...
echo "## Clusterpedia" | gum format

helm upgrade --install clusterpedia clusterpedia \
    --repo https://clusterpedia-io.github.io/clusterpedia-helm \
    --namespace clusterpedia-system --create-namespace \
    --set persistenceMatchNode=None --set installCRDs=true \
    --wait
